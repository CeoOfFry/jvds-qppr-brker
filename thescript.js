...
console.log("%c[:_____cheat_made_with_anger_by_javed_____:]%s", css, "");
console.log("%c[This cheat is still unfinished, some questions and assignment types (like exams) might not be supported yet]", "color: #707070");
