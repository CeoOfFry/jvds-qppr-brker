...
if (!url.includes("/en/assignments") || !url.includes("topics") || !url.includes("/questions")) {
    ...
    if (quickMode) {
            ...
            case "correct_order":
                {
                    for (let j = 0; j < Object.keys(_q.choices).length; j++) {
                        ...
                        console.log("  ", (j + 1), _ch.body[0].text);
                    }
                }
                break;
        ...
        switch (_q.answer_type) {
            case "multiple_choice":
                {
                    for (let j = 0; j < Object.keys(_q.choices).length; j++) {
                        ...
                        if (_ch.correct)
                            console.log("%ccorrect", "color: #9980FF", "|", _ch.body[0].text);
                        else
                            console.log("wrong   |", _ch.body[0].text);
                    }
                }
                break;
            ...
            case "exact_value":
                {
                    let _ch = _q.choices[0]
                    console.log("	The answer is " + _ch.body[0].text + "");
                    console.log("	(Case sensitive: " + _q.case_sensitive + ")");
                }
                break;
        ...
        let exp = removedHtml(_q.explanation[0].text)
...
console.log("%c cheat made with anger %s", css, "by javed");
console.log("%c[This cheat is incomplete, some questions types might not be supported yet]", "color: #707070");
